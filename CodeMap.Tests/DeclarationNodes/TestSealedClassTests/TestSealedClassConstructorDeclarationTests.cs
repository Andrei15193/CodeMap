...
{
    public class TestSealedClassConstructorDeclarationTests : DeclarationNodeTests<ConstructorDeclaration>, IConstructorDeclarationTests
    {
        protected override bool DeclarationNodePredicate(ConstructorDeclaration constructorDeclaration)
            => constructorDeclaration.Name == nameof(TestSealedClass) && constructorDeclaration.DeclaringType.Name == nameof(TestSealedClass);

        [Fact]
        public void MemberEqualityComparison()
        {
            var constructorInfo = typeof(TestSealedClass).GetConstructor(Type.EmptyTypes);
        ...
        public void HasDeclartingTypeSet()
            => Assert.True(typeof(TestSealedClass) == DeclarationNode.DeclaringType);
