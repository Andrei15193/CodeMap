...
{
    public class TestClassTestMethod26DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod26), new[] { typeof(byte*[]) });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod26", DeclarationNode.Name);
