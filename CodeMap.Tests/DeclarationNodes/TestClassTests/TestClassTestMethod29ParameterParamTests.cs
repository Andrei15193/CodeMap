...
{
    public class TestClassTestMethod29ParameterParamTests : DeclarationNodeTests<MethodDeclaration>, IParameterDataTests
    {
        ...
        public void HasTypeSet()
            => Assert.True(typeof(decimal*[]) == Parameter.Type);
