...
{
    public class TestClassTestMethod28ParameterParamTests : DeclarationNodeTests<MethodDeclaration>, IParameterDataTests
    {
        ...
        public void HasTypeSet()
            => Assert.True(typeof(double*) == Parameter.Type);
