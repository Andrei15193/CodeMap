...
{
    public class TestClassTestMethod5DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod5), new[] { typeof(int).MakeByRefType() });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod5", DeclarationNode.Name);
