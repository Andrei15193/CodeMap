...
{
    public class TestClassTestMethod11ParameterParamTests : DeclarationNodeTests<MethodDeclaration>, IParameterDataTests
    {
        ...
        public void HasTypeSet()
            => Assert.True(typeof(char[][]) == Parameter.Type);
