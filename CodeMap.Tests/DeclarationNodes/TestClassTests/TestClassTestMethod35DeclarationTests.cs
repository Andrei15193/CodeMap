...
{
    public class TestClassTestMethod35DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod35), new[] { typeof(void**[]) });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod35", DeclarationNode.Name);
