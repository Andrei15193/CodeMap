...
{
    public class TestClassTestMethodParameterParam1Tests : DeclarationNodeTests<MethodDeclaration>, IParameterDataTests
    {
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "class method parameter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "class method parameter test 2", typeof(object)), ("Value3", "class method parameter test 3", typeof(object)) }
            );
