...
{
    public class TestClassTestMethod20DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod20), new[] { typeof(object).MakeByRefType() });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod20", DeclarationNode.Name);
