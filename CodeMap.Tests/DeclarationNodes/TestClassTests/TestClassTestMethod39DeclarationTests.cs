...
{
    public class TestClassTestMethod39DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod39), new[] { Type.MakeGenericMethodParameter(0).MakeByRefType() });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod39", DeclarationNode.Name);
