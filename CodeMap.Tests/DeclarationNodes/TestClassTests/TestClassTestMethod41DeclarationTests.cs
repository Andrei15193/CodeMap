...
{
    public class TestClassTestMethod41DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod41), new[] { typeof(string) });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod41", DeclarationNode.Name);
