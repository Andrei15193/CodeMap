...
{
    public class TestClassTestMethod22DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod22), new[] { typeof(TestClass<>).GetGenericArguments().Single() });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod22", DeclarationNode.Name);
