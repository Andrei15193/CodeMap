...
{
    public class TestClassTestMethod30ParameterParamTests : DeclarationNodeTests<MethodDeclaration>, IParameterDataTests
    {
        ...
        public void HasTypeSet()
            => Assert.True(typeof(short*[]) == Parameter.Type);
