...
{
    public class TestClassTestMethod19DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod19), new[] { typeof(object) });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod19", DeclarationNode.Name);
