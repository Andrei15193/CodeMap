...
{
    public class TestClassTestMethod38DeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestClass<>).GetRuntimeMethod(nameof(TestClass<int>.TestMethod38), new[] { Type.MakeGenericMethodParameter(0) });
        ...
        public void HasNameSet()
            => Assert.Equal("TestMethod38", DeclarationNode.Name);
