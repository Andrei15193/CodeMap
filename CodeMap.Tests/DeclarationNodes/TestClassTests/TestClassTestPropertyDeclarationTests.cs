...
{
    public class TestClassTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestClass<int>.TestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestClass<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestClass<>).GetRuntimeProperty(nameof(TestClass<int>.TestProperty));
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "class property test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "class property test 2", typeof(object)), ("Value3", "class property test 3", typeof(object)) }
            );
        ...
        public void HasGetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "class property getter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "class property getter test 2", typeof(object)), ("Value3", "class property getter test 3", typeof(object)) }
            );
        ...
        public void HasGetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "class property getter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "class property getter return test 2", typeof(object)), ("Value3", "class property getter return test 3", typeof(object)) }
            );
