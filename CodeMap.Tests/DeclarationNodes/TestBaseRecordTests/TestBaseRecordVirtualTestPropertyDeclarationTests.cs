...
{
    public class TestBaseRecordVirtualTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestBaseRecord.VirtualTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestBaseRecord);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestBaseRecord).GetRuntimeProperty(nameof(TestBaseRecord.VirtualTestProperty));
