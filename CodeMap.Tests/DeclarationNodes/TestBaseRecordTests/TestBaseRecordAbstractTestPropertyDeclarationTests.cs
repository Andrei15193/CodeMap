...
{
    public class TestBaseRecordAbstractTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestBaseRecord.AbstractTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestBaseRecord);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestBaseRecord).GetRuntimeProperty(nameof(TestBaseRecord.AbstractTestProperty));
