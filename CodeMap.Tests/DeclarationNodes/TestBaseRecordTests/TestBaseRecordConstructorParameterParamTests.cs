...
{
    public class TestBaseRecordConstructorParameterParamTests : DeclarationNodeTests<ConstructorDeclaration>, IParameterDataTests
    {
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record constructor parameter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record constructor parameter test 2", typeof(object)), ("Value3", "record constructor parameter test 3", typeof(object)) }
            );
