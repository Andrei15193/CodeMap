...
{
    public class TestBaseRecordStaticTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        protected override bool DeclarationNodePredicate(MethodDeclaration methodDeclaration)
            => methodDeclaration.Name == nameof(TestBaseRecord.StaticTestMethod) && methodDeclaration.DeclaringType.Name == nameof(TestBaseRecord);

        [Fact]
        public void MemberEqualityComparison()
        {
            var methodInfo = typeof(TestBaseRecord).GetRuntimeMethod(nameof(TestBaseRecord.StaticTestMethod), Type.EmptyTypes);
        ...
        public void HasNameSet()
            => Assert.Equal("StaticTestMethod", DeclarationNode.Name);
