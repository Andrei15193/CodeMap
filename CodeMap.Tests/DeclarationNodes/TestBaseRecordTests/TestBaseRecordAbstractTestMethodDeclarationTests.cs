...
{
    public class TestBaseRecordAbstractTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        protected override bool DeclarationNodePredicate(MethodDeclaration methodDeclaration)
            => methodDeclaration.Name == nameof(TestBaseRecord.AbstractTestMethod) && methodDeclaration.DeclaringType.Name == nameof(TestBaseRecord);

        [Fact]
        public void MemberEqualityComparison()
        {
            var methodInfo = typeof(TestBaseRecord).GetRuntimeMethod(nameof(TestBaseRecord.AbstractTestMethod), Type.EmptyTypes);
