...
{
    public class TestBaseRecordStaticTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestBaseRecord.StaticTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestBaseRecord);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestBaseRecord).GetRuntimeProperty(nameof(TestBaseRecord.StaticTestProperty));
        ...
        public void HasNameSet()
            => Assert.Equal("StaticTestProperty", DeclarationNode.Name);
