...
{
    public class TestExplicitClassConstructorDeclarationTests : DeclarationNodeTests<ConstructorDeclaration>, IConstructorDeclarationTests
    {
        protected override bool DeclarationNodePredicate(ConstructorDeclaration constructorDeclaration)
            => constructorDeclaration.Name == nameof(TestExplicitClass) && constructorDeclaration.DeclaringType.Name == nameof(TestExplicitClass);

        [Fact]
        public void MemberEqualityComparison()
        {
            var constructorInfo = typeof(TestExplicitClass).GetConstructor(Type.EmptyTypes);
