...
{
    public class TestExplicitClassTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        protected override bool DeclarationNodePredicate(MethodDeclaration methodDeclaration)
            => methodDeclaration.Name == typeof(ITestExplicitInterface).Namespace + "." + nameof(ITestExplicitInterface) + "." + nameof(ITestExplicitInterface.TestMethod) && methodDeclaration.DeclaringType.Name == nameof(TestExplicitClass);

        [Fact]
        public void MemberEqualityComparison()
        {
            var methodInfo = typeof(TestExplicitClass).GetMethod(typeof(ITestExplicitInterface).Namespace + "." + nameof(ITestExplicitInterface) + "." + nameof(ITestExplicitInterface.TestMethod), BindingFlags.NonPublic | BindingFlags.Instance, Type.DefaultBinder, Type.EmptyTypes, null);
        ...
        public void HasNameSet()
            => Assert.Equal("CodeMap.Tests.Data.ITestExplicitInterface.TestMethod", DeclarationNode.Name);
        ...
        public void HasDeclartingTypeSet()
            => Assert.True(typeof(TestExplicitClass) == DeclarationNode.DeclaringType);
