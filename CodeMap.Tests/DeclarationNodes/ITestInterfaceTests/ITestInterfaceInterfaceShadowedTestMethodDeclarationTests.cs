...
{
    public class ITestInterfaceInterfaceShadowedTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        protected override bool DeclarationNodePredicate(MethodDeclaration methodDeclaration)
            => methodDeclaration.Name == nameof(ITestInterface<int>.InterfaceShadowedTestMethod) && methodDeclaration.DeclaringType.Name == nameof(ITestInterface<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var methodInfo = typeof(ITestInterface<>).GetRuntimeMethod(nameof(ITestInterface<int>.InterfaceShadowedTestMethod), Type.EmptyTypes);
