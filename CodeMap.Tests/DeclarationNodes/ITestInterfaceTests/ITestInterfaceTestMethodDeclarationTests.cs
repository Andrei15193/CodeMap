...
namespace CodeMap.Tests.DeclarationNodes.ITestInterfaceTests
{
    public class ITestInterfaceTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>
    {
        ...
        {
            var methodInfo = typeof(ITestInterface<>).GetRuntimeMethod(nameof(ITestInterface<int>.TestMethod), new[] { typeof(int) });
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface method test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface method test 2", typeof(object)), ("Value3", "interface method test 3", typeof(object)) }
            );
        ...
        public void HasReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface method return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface method return test 2", typeof(object)), ("Value3", "interface method return test 3", typeof(object)) }
            );
