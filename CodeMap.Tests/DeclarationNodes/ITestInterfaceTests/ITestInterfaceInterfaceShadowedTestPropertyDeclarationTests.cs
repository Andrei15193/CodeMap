...
{
    public class ITestInterfaceInterfaceShadowedTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(ITestInterface<int>.InterfaceShadowedTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(ITestInterface<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(ITestInterface<>).GetRuntimeProperty(nameof(ITestInterface<int>.InterfaceShadowedTestProperty));
