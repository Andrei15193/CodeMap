...
{
    public class ITestInterfaceTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(ITestInterface<int>.TestProperty) && propertyDeclaration.DeclaringType.Name == nameof(ITestInterface<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(ITestInterface<>).GetRuntimeProperty(nameof(ITestInterface<int>.TestProperty));
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface property test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface property test 2", typeof(object)), ("Value3", "interface property test 3", typeof(object)) }
            );
        ...
        public void HasGetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface property getter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface property getter test 2", typeof(object)), ("Value3", "interface property getter test 3", typeof(object)) }
            );
        ...
        public void HasGetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface property getter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface property getter return test 2", typeof(object)), ("Value3", "interface property getter return test 3", typeof(object)) }
            );
        ...
        public void HasSetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface property setter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface property setter test 2", typeof(object)), ("Value3", "interface property setter test 3", typeof(object)) }
            );
        ...
        public void HasSetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface property setter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface property setter return test 2", typeof(object)), ("Value3", "interface property setter return test 3", typeof(object)) }
            );
        ...
        public void HasValueSet()
            => Assert.NotEmpty(DeclarationNode.Value.Content);
