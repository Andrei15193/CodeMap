...
{
    public class ITestInterfaceIndexerDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        ...
        {
            var propertyInfo = typeof(ITestInterface<>).GetRuntimeProperty("Item");
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface indexer test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface indexer test 2", typeof(object)), ("Value3", "interface indexer test 3", typeof(object)) }
            );
        ...
        public void HasGetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface indexer getter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface indexer getter test 2", typeof(object)), ("Value3", "interface indexer getter test 3", typeof(object)) }
            );
        ...
        public void HasGetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface indexer getter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface indexer getter return test 2", typeof(object)), ("Value3", "interface indexer getter return test 3", typeof(object)) }
            );
        ...
        public void HasSetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface indexer setter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface indexer setter test 2", typeof(object)), ("Value3", "interface indexer setter test 3", typeof(object)) }
            );
        ...
        public void HasSetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "interface indexer setter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "interface indexer setter return test 2", typeof(object)), ("Value3", "interface indexer setter return test 3", typeof(object)) }
            );
