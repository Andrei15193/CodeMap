...
{
    public class TestBaseClassStaticTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestBaseClass.StaticTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestBaseClass);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestBaseClass).GetRuntimeProperty(nameof(TestBaseClass.StaticTestProperty));
