...
{
    public class TestBaseClassAbstractTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        protected override bool DeclarationNodePredicate(MethodDeclaration methodDeclaration)
            => methodDeclaration.Name == nameof(TestBaseClass.AbstractTestMethod) && methodDeclaration.DeclaringType.Name == nameof(TestBaseClass);

        [Fact]
        public void MemberEqualityComparison()
        {
            var methodInfo = typeof(TestBaseClass).GetRuntimeMethod(nameof(TestBaseClass.AbstractTestMethod), Type.EmptyTypes);
