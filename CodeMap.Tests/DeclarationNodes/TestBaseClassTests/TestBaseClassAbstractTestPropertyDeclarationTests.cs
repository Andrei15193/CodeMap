...
{
    public class TestBaseClassAbstractTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestBaseClass.AbstractTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestBaseClass);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestBaseClass).GetRuntimeProperty(nameof(TestBaseClass.AbstractTestProperty));
