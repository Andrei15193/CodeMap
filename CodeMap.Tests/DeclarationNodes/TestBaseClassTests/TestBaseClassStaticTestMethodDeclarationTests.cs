...
{
    public class TestBaseClassStaticTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        protected override bool DeclarationNodePredicate(MethodDeclaration methodDeclaration)
            => methodDeclaration.Name == nameof(TestBaseClass.StaticTestMethod) && methodDeclaration.DeclaringType.Name == nameof(TestBaseClass);

        [Fact]
        public void MemberEqualityComparison()
        {
            var methodInfo = typeof(TestBaseClass).GetRuntimeMethod(nameof(TestBaseClass.StaticTestMethod), Type.EmptyTypes);
