...
{
    public class TestBaseClassClassShadowedTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        protected override bool DeclarationNodePredicate(MethodDeclaration methodDeclaration)
            => methodDeclaration.Name == nameof(TestBaseClass.ClassShadowedTestMethod) && methodDeclaration.DeclaringType.Name == nameof(TestBaseClass);

        [Fact]
        public void MemberEqualityComparison()
        {
            var methodInfo = typeof(TestBaseClass).GetRuntimeMethod(nameof(TestBaseClass.ClassShadowedTestMethod), Type.EmptyTypes);
        ...
        public void HasNameSet()
            => Assert.Equal("ClassShadowedTestMethod", DeclarationNode.Name);
