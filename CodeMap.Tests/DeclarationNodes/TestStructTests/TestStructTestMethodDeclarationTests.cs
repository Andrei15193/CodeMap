...
{
    public class TestStructTestMethodDeclarationTests : DeclarationNodeTests<MethodDeclaration>, IMethodDeclarationTests
    {
        ...
        {
            var methodInfo = typeof(TestStruct<>).GetRuntimeMethod(nameof(TestStruct<int>.TestMethod), new[] { typeof(int) });
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "struct method test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "struct method test 2", typeof(object)), ("Value3", "struct method test 3", typeof(object)) }
            );
        ...
        public void HasReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "struct method return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "struct method return test 2", typeof(object)), ("Value3", "struct method return test 3", typeof(object)) }
            );
