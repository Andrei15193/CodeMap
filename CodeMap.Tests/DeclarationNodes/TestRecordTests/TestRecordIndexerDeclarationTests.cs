...
{
    public class TestRecordIndexerDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == "Item" && propertyDeclaration.DeclaringType.Name == nameof(TestRecord<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestRecord<>).GetRuntimeProperty("Item");
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record indexer test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record indexer test 2", typeof(object)), ("Value3", "record indexer test 3", typeof(object)) }
            );
        ...
        public void HasGetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record indexer getter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record indexer getter test 2", typeof(object)), ("Value3", "record indexer getter test 3", typeof(object)) }
            );
        ...
        public void HasGetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record indexer getter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record indexer getter return test 2", typeof(object)), ("Value3", "record indexer getter return test 3", typeof(object)) }
            );
        ...
        public void HasSetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record indexer setter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record indexer setter test 2", typeof(object)), ("Value3", "record indexer setter test 3", typeof(object)) }
            );
        ...
        public void HasSetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record indexer setter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record indexer setter return test 2", typeof(object)), ("Value3", "record indexer setter return test 3", typeof(object)) }
            );
