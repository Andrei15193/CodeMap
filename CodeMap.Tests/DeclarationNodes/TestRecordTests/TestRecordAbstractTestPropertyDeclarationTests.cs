...
{
    public class TestRecordAbstractTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestRecord<int>.AbstractTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestRecord<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestRecord<>).GetRuntimeProperty(nameof(TestRecord<int>.AbstractTestProperty));
        ...
        public void HasNameSet()
            => Assert.Equal("AbstractTestProperty", DeclarationNode.Name);
