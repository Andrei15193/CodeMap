...
{
    public class TestRecordNestedTestStructConstructorDeclarationTests : DeclarationNodeTests<ConstructorDeclaration>, IConstructorDeclarationTests
    {
        protected override bool DeclarationNodePredicate(ConstructorDeclaration constructorDeclaration)
            => constructorDeclaration.Name == nameof(TestRecord<int>.NestedTestStruct) && constructorDeclaration.DeclaringType.Name == nameof(TestRecord<int>.NestedTestStruct) && constructorDeclaration.DeclaringType.DeclaringType.Name == nameof(TestRecord<int>);
        ...
        public void HasDeclartingTypeSet()
            => Assert.True(typeof(TestRecord<>.NestedTestStruct) == DeclarationNode.DeclaringType);
