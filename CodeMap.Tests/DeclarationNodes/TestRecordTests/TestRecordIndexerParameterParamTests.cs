...
{
    public class TestRecordIndexerParameterParamTests : DeclarationNodeTests<PropertyDeclaration>, IParameterDataTests
    {
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record indexer parameter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record indexer parameter test 2", typeof(object)), ("Value3", "record indexer parameter test 3", typeof(object)) }
            );
