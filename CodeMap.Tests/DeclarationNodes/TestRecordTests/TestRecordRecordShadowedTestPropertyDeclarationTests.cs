...
{
    public class TestRecordRecordShadowedTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestRecord<int>.RecordShadowedTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestRecord<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestRecord<>).GetProperty(nameof(TestRecord<int>.RecordShadowedTestProperty), BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly);
        ...
        public void HasNameSet()
            => Assert.Equal("RecordShadowedTestProperty", DeclarationNode.Name);
