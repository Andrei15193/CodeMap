...
{
    public class TestRecordTestPublicReadPrivateWritePropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestRecord<int>.TestPublicReadPrivateWriteProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestRecord<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestRecord<>).GetRuntimeProperty(nameof(TestRecord<int>.TestPublicReadPrivateWriteProperty));
