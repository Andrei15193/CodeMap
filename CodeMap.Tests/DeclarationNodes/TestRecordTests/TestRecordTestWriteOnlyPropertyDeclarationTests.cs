...
{
    public class TestRecordTestWriteOnlyPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestRecord<int>.TestWriteOnlyProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestRecord<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestRecord<>).GetRuntimeProperty(nameof(TestRecord<int>.TestWriteOnlyProperty));
        ...
        public void HasNameSet()
            => Assert.Equal("TestWriteOnlyProperty", DeclarationNode.Name);
        ...
        public void HasGetterAccessModifierSet()
            => Assert.Null(DeclarationNode.Getter);
