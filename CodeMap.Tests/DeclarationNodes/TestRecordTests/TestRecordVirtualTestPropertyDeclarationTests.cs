...
{
    public class TestRecordVirtualTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestRecord<int>.VirtualTestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestRecord<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestRecord<>).GetRuntimeProperty(nameof(TestRecord<int>.VirtualTestProperty));
        ...
        public void HasNameSet()
            => Assert.Equal("VirtualTestProperty", DeclarationNode.Name);
