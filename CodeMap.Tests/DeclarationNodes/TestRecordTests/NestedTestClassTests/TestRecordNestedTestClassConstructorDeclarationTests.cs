...
{
    public class TestRecordNestedTestClassConstructorDeclarationTests : DeclarationNodeTests<ConstructorDeclaration>, IConstructorDeclarationTests
    {
        protected override bool DeclarationNodePredicate(ConstructorDeclaration constructorDeclaration)
            => constructorDeclaration.Name == nameof(TestRecord<int>.NestedTestClass) && constructorDeclaration.DeclaringType.Name == nameof(TestRecord<int>.NestedTestClass) && constructorDeclaration.DeclaringType.DeclaringType.Name == nameof(TestRecord<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var constructorInfo = typeof(TestRecord<>.NestedTestClass).GetConstructor(Type.EmptyTypes);
        ...
        public void HasDeclartingTypeSet()
            => Assert.True(typeof(TestRecord<>.NestedTestClass) == DeclarationNode.DeclaringType);
