...
{
    public class TestRecordTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(TestRecord<int>.TestProperty) && propertyDeclaration.DeclaringType.Name == nameof(TestRecord<int>);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(TestRecord<>).GetRuntimeProperty(nameof(TestRecord<int>.TestProperty));
        ...
        public void HasTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record property test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record property test 2", typeof(object)), ("Value3", "record property test 3", typeof(object)) }
            );
        ...
        public void HasGetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record property getter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record property getter test 2", typeof(object)), ("Value3", "record property getter test 3", typeof(object)) }
            );
        ...
        public void HasGetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record property getter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record property getter return test 2", typeof(object)), ("Value3", "record property getter return test 3", typeof(object)) }
            );
        ...
        public void HasSetterTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record property setter test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record property setter test 2", typeof(object)), ("Value3", "record property setter test 3", typeof(object)) }
            );
        ...
        public void HasSetterReturnTestAttribute()
            => AssertAttribute<TestAttribute>(
                ...
                new (string, object, Type)[] { ("value1", "record property setter return test 1", typeof(object)) },
                new (string, object, Type)[] { ("Value2", "record property setter return test 2", typeof(object)), ("Value3", "record property setter return test 3", typeof(object)) }
            );
