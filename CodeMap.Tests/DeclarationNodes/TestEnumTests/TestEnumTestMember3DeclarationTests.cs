...
{
    public class TestEnumTestMember3DeclarationTests : DeclarationNodeTests<ConstantDeclaration>, IConstantDeclarationTests
    {
        ...
        public void HasNameSet()
            => Assert.Equal("TestMember3", DeclarationNode.Name);
        ...
        public void HasValueSet()
            => Assert.Equal(TestEnum.TestMember3, DeclarationNode.Value);
