...
{
    public class TestAbstractClassDeclarationTests : DeclarationNodeTests<ClassDeclaration>, IClassDeclarationTests
    {
        protected override bool DeclarationNodePredicate(ClassDeclaration classDeclaration)
            => classDeclaration.Name == nameof(TestAbstractClass);

        [Fact]
        public void TypeEqualityComparison()
        {
            Assert.True(DeclarationNode.Equals(typeof(TestAbstractClass)));
            Assert.True(DeclarationNode.Equals(typeof(TestAbstractClass) as object));
            Assert.True(typeof(TestAbstractClass) == DeclarationNode);
            Assert.True(DeclarationNode == typeof(TestAbstractClass));
