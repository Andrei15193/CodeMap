...
{
    public class ITestExplicitInterfaceTestPropertyDeclarationTests : DeclarationNodeTests<PropertyDeclaration>, IPropertyDeclarationTests
    {
        protected override bool DeclarationNodePredicate(PropertyDeclaration propertyDeclaration)
            => propertyDeclaration.Name == nameof(ITestExplicitInterface.TestProperty) && propertyDeclaration.DeclaringType.Name == nameof(ITestExplicitInterface);

        [Fact]
        public void MemberEqualityComparison()
        {
            var propertyInfo = typeof(ITestExplicitInterface).GetRuntimeProperty(nameof(ITestExplicitInterface.TestProperty));
