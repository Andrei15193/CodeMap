...
{
    public class ITestExplicitInterfaceTestEventDeclarationTests : DeclarationNodeTests<EventDeclaration>, IEventDeclarationTests
    {
        protected override bool DeclarationNodePredicate(EventDeclaration eventDeclaration)
            => eventDeclaration.Name == nameof(ITestExplicitInterface.TestEvent) && eventDeclaration.DeclaringType.Name == nameof(ITestExplicitInterface);

        [Fact]
        public void MemberEqualityComparison()
        {
            var eventInfo = typeof(ITestExplicitInterface).GetRuntimeEvent(nameof(ITestExplicitInterface.TestEvent));
