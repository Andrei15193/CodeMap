...
namespace CodeMap.Elements
{
    ...
    {
        internal ParameterReferenceDocumentationElement(string parameterName)
        {
        ...
        public override void Accept(DocumentationVisitor visitor)
            => visitor.VisitParameterReference(ParameterName);
        ...
        public override Task AcceptAsync(DocumentationVisitor visitor, CancellationToken cancellationToken)
            => visitor.VisitParameterReferenceAsync(ParameterName, cancellationToken);
    }
}