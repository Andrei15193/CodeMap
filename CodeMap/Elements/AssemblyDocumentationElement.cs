...
namespace CodeMap.Elements
{
    ...
    public class AssemblyDocumentationElement : DocumentationElement, IEquatable<Assembly>, IEquatable<AssemblyName>
    {
        ...
        /// <param name="assemblyDocumentationElement">The <see cref="AssemblyDocumentationElement"/> to compare.</param>
        ...
        public static bool operator ==(AssemblyDocumentationElement assemblyDocumentationElement, Assembly assembly)
        ...
        /// <param name="assemblyDocumentationElement">The <see cref="AssemblyDocumentationElement"/> to compare.</param>
        /// <returns>Returns <c>true</c> if the two provided instances are equal; <c>false</c> otherwise.</returns>
        public static bool operator ==(Assembly assembly, AssemblyDocumentationElement assemblyDocumentationElement)
            => Equals(assemblyDocumentationElement, assembly);
        ...
        /// <returns>Returns <c>true</c> if the two provided instances are equal; <c>false</c> otherwise.</returns>
        public static bool operator ==(AssemblyDocumentationElement assemblyDocumentationElement, AssemblyName assemblyName)
        ...
        /// <param name="assemblyDocumentationElement">The <see cref="AssemblyDocumentationElement"/> to compare.</param>
        /// <returns>Returns <c>true</c> if the two provided instances are equal; <c>false</c> otherwise.</returns>
        public static bool operator ==(AssemblyName assemblyName, AssemblyDocumentationElement assemblyDocumentationElement)
            => Equals(assemblyDocumentationElement, assemblyName);
        ...
        internal AssemblyDocumentationElement()
        {
        }
        ...
        public IReadOnlyCollection<NamespaceDocumentationElement> Namespaces { get; internal set; }
        ...
        /// <summary>Determines whether the current <see cref="AssemblyDocumentationElement"/> is equal to the provided <paramref name="obj"/>.</summary>
        /// <param name="obj">The <see cref="object"/> to compare to.</param>
        /// <returns>Returns <c>true</c> if the current <see cref="AssemblyDocumentationElement"/> references the provided <paramref name="obj"/>; <c>false</c> otherwise.</returns>
        /// <remarks>
