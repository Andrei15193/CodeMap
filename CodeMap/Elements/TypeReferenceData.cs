...
namespace CodeMap.Elements
{
    ...
    public abstract class TypeReferenceData : IEquatable<Type>
    {
        /// <summary>Determines whether the provided <paramref name="typeReference"/> and <paramref name="type"/> are equal.</summary>
        /// <param name="typeReference">The <see cref="TypeReferenceData"/> to compare.</param>
        ...
        public static bool operator ==(TypeReferenceData typeReference, Type type)
        ...
        /// <param name="typeReference">The <see cref="TypeReferenceData"/> to compare.</param>
        /// <returns>Returns <c>true</c> if the two provided instances are equal; <c>false</c> otherwise.</returns>
        public static bool operator ==(Type type, TypeReferenceData typeReference)
            => Equals(typeReference, type);
        ...
        internal TypeReferenceData()
        {
        }

        /// <summary>Determines whether the current <see cref="TypeReferenceData"/> is equal to the provided <paramref name="type"/>.</summary>
        /// <param name="type">The <see cref="Type"/> to compare to.</param>
        /// <returns>Returns <c>true</c> if the current <see cref="TypeReferenceData"/> references the provided <paramref name="type"/>; <c>false</c> otherwise.</returns>
        public abstract bool Equals(Type type);

        /// <summary>Determines whether the current <see cref="TypeReferenceData"/> is equal to the provided <paramref name="obj"/>.</summary>
        /// <param name="obj">The <see cref="object"/> to compare to.</param>
        /// <returns>Returns <c>true</c> if the current <see cref="TypeReferenceData"/> references the provided <paramref name="obj"/>; <c>false</c> otherwise.</returns>
        /// <remarks>
