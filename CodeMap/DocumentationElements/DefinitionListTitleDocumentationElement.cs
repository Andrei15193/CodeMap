...
{
    /// <summary>Represents a definition list header corresponding to the <c>itemheader</c> XML element.</summary>
    public class DefinitionListTitleDocumentationElement : DocumentationElement
    {
        internal DefinitionListTitleDocumentationElement(IEnumerable<InlineDocumentationElement> content, IReadOnlyDictionary<string, string> xmlAttributes)
        {
        ...
        public override void Accept(DocumentationVisitor visitor)
            => visitor.VisitDefinitionListTitle(this);
    }
}
