...
{
    /// <summary>Represents a documented record declaration.</summary>
    public sealed class RecordDeclaration : TypeDeclaration
    {
        internal RecordDeclaration(TypeReference typeReference)
            : base(typeReference)
        {
        }

        /// <summary>Indicates whether the record is abstract.</summary>
        public bool IsAbstract { get; internal set; }

        /// <summary>Indicates whether the record is sealed.</summary>
        public bool IsSealed { get; internal set; }

        /// <summary>The record generic parameters.</summary>
        public IReadOnlyList<GenericTypeParameterData> GenericParameters { get; internal set; }

        /// <summary>The base type.</summary>
        public TypeReference BaseRecord { get; internal set; }
