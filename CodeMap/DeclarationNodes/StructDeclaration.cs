...
namespace CodeMap.DeclarationNodes
{
    ...
    public sealed class StructDeclaration : TypeDeclaration
    {
        ...
        /// <summary>Determines whether the current <see cref="StructDeclaration"/> is equal to the provided <paramref name="typeReference"/>.</summary>
        /// <param name="typeReference">The <see cref="TypeReference"/> to compare to.</param>
        /// <returns>Returns <c>true</c> if the current <see cref="StructDeclaration"/> references the provided <paramref name="typeReference"/>; <c>false</c> otherwise.</returns>
