...
namespace CodeMap.DeclarationNodes
{
    ...
    public sealed class ClassDeclaration : TypeDeclaration
    {
        ...
        /// <summary>Determines whether the current <see cref="ClassDeclaration"/> is equal to the provided <paramref name="typeReference"/>.</summary>
        /// <param name="typeReference">The <see cref="TypeReference"/> to compare to.</param>
        /// <returns>Returns <c>true</c> if the current <see cref="ClassDeclaration"/> references the provided <paramref name="typeReference"/>; <c>false</c> otherwise.</returns>
