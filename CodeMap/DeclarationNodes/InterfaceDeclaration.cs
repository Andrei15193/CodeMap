...
namespace CodeMap.DeclarationNodes
{
    ...
    public sealed class InterfaceDeclaration : TypeDeclaration
    {
        ...
        /// <summary>Determines whether the current <see cref="InterfaceDeclaration"/> is equal to the provided <paramref name="typeReference"/>.</summary>
        /// <param name="typeReference">The <see cref="TypeReference"/> to compare to.</param>
        /// <returns>Returns <c>true</c> if the current <see cref="InterfaceDeclaration"/> references the provided <paramref name="typeReference"/>; <c>false</c> otherwise.</returns>
